# -*- coding: utf-8 -*-
"""Linear_regression_drug_solubility.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1B8fiTnX9DhW5LQNsMkzTaOuEAfMc0WFE
...
The dataset  contains a csv table, in which columns below are used:
...
"""*Assigning the ninth column (index -2) to the Y matrix (labels for further modeling)*"""
...
"""# Now let's define a class "modeling" for model fitting and evaluation, since we will use it several times"""
...
#           % r2_score(labels, Y_pred))

"""# *Predict X_train*"""

Predict_X_train = Modeling(X_train, Y_train)

"""# *Predict X_test*"""

Predict_X_test = Modeling(X_test, Y_test)

"""# Now let's use entire dataset for model training (For Comparison)"""

Predict_X_test = Modeling(X, Y)
...
Y_train.shape, Predict_X_train.Y_pred.shape

Y_test.shape, Predict_X_test.Y_pred.shape
...
Y_pred_train = Predict_X_train.Y_pred
Y_pred_test = Predict_X_test.Y_pred
